        ...
        <Form onSubmit={onSubmitHandler}>
          ...
          <div className="from-group">
            ...
            <div>
              ...
              <div>
                <input type="radio" name="activity" value="lipka" onChange={onChangeHandler} checked readOnly />
          ...
          <div className="from-group">
            ...
            <div>
              ...
              <div>
                <input type="radio" name="formofactivity" value="split" onChange={onChangeHandler} disabled />
                <label htmlFor="split">Парне</label>
              </div>
              <div>
                <input type="radio" name="formofactivity" value="individual" onChange={onChangeHandler} checked readOnly />
