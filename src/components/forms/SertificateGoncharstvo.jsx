      ...
      <FormBlock>
        ...
        <Form onSubmit={onSubmitHandler}>
          ...
          <div className="from-group">
            ...
            <div>
              <div>
                <input type="radio" name="activity" value="gonchsrstvo" checked={true} onChange={onChangeHandler} />
                <label htmlFor="gonchsrstvo">Гончарство</label>
              </div>
              <div>
                <input type="radio" name="activity" value="lipka" disabled={true} onChange={onChangeHandler} />
          ...
          <div className="from-group">
            ...
            <div>
              <div>
                <input type="radio" name="formofactivity" value="group" disabled={true} onChange={onChangeHandler} />
                <label htmlFor="group">Групове</label>
              </div>
              <div>
                <input type="radio" name="formofactivity" value="split" disabled={true} onChange={onChangeHandler} />
                <label htmlFor="split">Парне</label>
              </div>
              <div>
                <input type="radio" name="formofactivity" value="individual" disabled={true} onChange={onChangeHandler} />
